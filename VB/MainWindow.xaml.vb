...
Namespace WpfReportDesignerDataSourceWizard
    ...
    Partial Public Class MainWindow
        ...
        Shared Sub New()
            DependencyPropertyRegistrator(Of MainWindow).[New]().Register(Function(x) x.RunDataSourceWizardCommand, RunDataSourceWizardCommandProperty, Nothing)
        End Sub
        ...
        Private Shared Function CreateReport(ByVal ds As SqlDataSource, ByVal dataMember As String) As XtraReport
            Dim report = New XtraReport With {.DataSource = ds, .DataMember = dataMember}
            Return report
        End Function
    End Class
End Namespace
