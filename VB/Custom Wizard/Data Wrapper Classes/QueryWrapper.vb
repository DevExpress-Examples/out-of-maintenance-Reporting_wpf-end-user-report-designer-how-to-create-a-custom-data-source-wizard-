...
Namespace CustomDataSourceWizard
    Public Class QueryWrapper
        ...
        Private Function ValidateSql() As String
            ...
            Dim testDS = New SqlDataSource With {.ConnectionName = Me.OwnerDataSource.Connection.ConnectionName, .ConnectionParameters = Me.OwnerDataSource.Connection.ConnectionParameters}
            Try
